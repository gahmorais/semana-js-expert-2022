...
describe("#Routes - test suite for api response", () => {
  ...
  test(`GET /index.html - should response with filex stream`, async () => {
    const params = TestUtil.defaultHandlerParams();
  ...
  test(`GET /file.ext - should response with filex stream`, async () => {
    const params = TestUtil.defaultHandlerParams();
  ...
  test(`GET /unknown - given an inexistent route ir should response with 404`, async () => {
    const params = TestUtil.defaultHandlerParams();
